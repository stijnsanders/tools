...
OutputDir=.
OutputBaseFilename=AllSorts_64
Compression=lzma
...
[Files]
Source: "..\bin64\shexAllSorts.dll"; DestDir: "{app}"; Flags: ignoreversion regserver restartreplace uninsrestartdelete
Source: "shexAllSorts.txt"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\bin64\shexRename.exe"; DestDir: "{app}"; Flags: ignoreversion
