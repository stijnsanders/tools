...
// File generated on 14/04/2005 13:09:48 from Type Library described below.
...
// *********************************************************************//
  IXMLDOMDocument = interface(IXMLDOMNode)
    ...
    function createTextNode(const data: WideString): IXMLDOMCharacterData; safecall;
...
// *********************************************************************//
  IXMLDOMDocumentDisp = dispinterface
    ...
    function createTextNode(const data: WideString): IXMLDOMCharacterData; dispid 43;
...
// *********************************************************************//
  IXMLDOMText = interface(IXMLDOMCharacterData)
    ...
    function splitText(offset: Integer): IXMLDOMCharacterData; safecall;
  end;
...
// *********************************************************************//
  IXMLDOMTextDisp = dispinterface
    ['{2933BF87-7B36-11D2-B20E-00C04F983E60}']
    function splitText(offset: Integer): IXMLDOMCharacterData; dispid 123;
    property data: WideString dispid 109;
    property length: Integer readonly dispid 110;
    function substringData(offset: Integer; count: Integer): WideString; dispid 111;
    procedure appendData(const data: WideString); dispid 112;
...
// *********************************************************************//
  IMXSchemaDeclHandler = interface(IDispatch)
    ...
    procedure schemaElementDecl(const oSchemaElement: ISchemaItem); safecall;
  end;
...
// *********************************************************************//
  IMXSchemaDeclHandlerDisp = dispinterface
    ['{FA4BB38C-FAF9-4CCA-9302-D1DD0FE520DB}']
    procedure schemaElementDecl(const oSchemaElement: ISchemaItem); dispid 1403;
  end;
...
// *********************************************************************//
  ISchemaElement = interface(ISchemaParticle)
    ...
    function Get_substitutionGroup: ISchemaItem; safecall;
    ...
    property substitutionGroup: ISchemaItem read Get_substitutionGroup;
...
// *********************************************************************//
  ISchemaElementDisp = dispinterface
    ...
    property substitutionGroup: ISchemaItem readonly dispid 1471;
...
// *********************************************************************//
  ISchemaItemCollection = interface(IDispatch)
    ...
    function Get_item(index: Integer): ISchemaElement; safecall;
    function itemByName(const name: WideString): ISchemaElement; safecall;
    function itemByQName(const name: WideString; const namespaceURI: WideString): ISchemaElement; safecall;
    function Get_length: Integer; safecall;
    function Get__newEnum: IUnknown; safecall;
    property item[index: Integer]: ISchemaElement read Get_item; default;
    property length: Integer read Get_length;
    property _newEnum: IUnknown read Get__newEnum;
  end;
...
// *********************************************************************//
  ISchemaItemCollectionDisp = dispinterface
    ['{50EA08B2-DD1B-4664-9A50-C2F40F4BD79A}']
    property item[index: Integer]: ISchemaElement readonly dispid 0; default;
    function itemByName(const name: WideString): ISchemaElement; dispid 1423;
    function itemByQName(const name: WideString; const namespaceURI: WideString): ISchemaElement; dispid 1424;
...
// *********************************************************************//
  IXMLDOMSchemaCollection2 = interface(IXMLDOMSchemaCollection)
    ...
    function getDeclaration(const node: IXMLDOMNode): ISchemaElement; safecall;
...
// *********************************************************************//
  IXMLDOMSchemaCollection2Disp = dispinterface
    ...
    function getDeclaration(const node: IXMLDOMNode): ISchemaElement; dispid 1422;
    procedure add(const namespaceURI: WideString; var_: OleVariant); dispid 2;
    function get(const namespaceURI: WideString): IXMLDOMNode; dispid 3;
    procedure remove(const namespaceURI: WideString); dispid 4;
    property length: Integer readonly dispid 5;
